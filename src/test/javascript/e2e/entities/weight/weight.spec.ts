...
describe('Weight e2e test', () => {
    ...
    it('should create and save Weights', async () => {
        await weightComponentsPage.clickOnCreateButton();
        await weightUpdatePage.setDatetimeInput('01/01/2001' + protractor.Key.TAB + '02:30AM');
        expect(await weightUpdatePage.getDatetimeInput()).toContain('2001-01-01T02:30');
