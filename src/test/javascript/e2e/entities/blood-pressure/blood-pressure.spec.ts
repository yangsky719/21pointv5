...
describe('BloodPressure e2e test', () => {
    ...
    it('should create and save BloodPressures', async () => {
        await bloodPressureComponentsPage.clickOnCreateButton();
        await bloodPressureUpdatePage.setDatetimeInput('01/01/2001' + protractor.Key.TAB + '02:30AM');
        expect(await bloodPressureUpdatePage.getDatetimeInput()).toContain('2001-01-01T02:30');
