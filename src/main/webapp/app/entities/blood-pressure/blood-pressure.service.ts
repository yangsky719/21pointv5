...
export class BloodPressureService {
    ...
    private convertDateFromClient(bloodPressure: IBloodPressure): IBloodPressure {
        const copy: IBloodPressure = Object.assign({}, bloodPressure, {
            datetime: bloodPressure.datetime != null && bloodPressure.datetime.isValid() ? bloodPressure.datetime.toJSON() : null
        });
        return copy;
    }
    ...
    private convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        res.body.forEach((bloodPressure: IBloodPressure) => {
            bloodPressure.datetime = bloodPressure.datetime != null ? moment(bloodPressure.datetime) : null;
        });
        return res;
    }
}
